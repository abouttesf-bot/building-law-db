const articlesData = [
  ...
  },
  {
    ...
    "note": "【令127条：屋外への出口等】法35条が適用される建築物の避難階には、直通階段から道路・公園等に通じる屋外への出口を設け、その幅は直通階段の幅の合計以上とする。<br><br>【令128条：敷地内の通路幅員】建築物の出口から道路等に通じる敷地内の通路幅員は1.5m以上。ただし3階以下かつ延べ面積200㎡未満の建築物は90cm以上で可。<br><br>【令128条の2：大規模建築物の敷地内通路】▶第1項：木造建築物等で延べ1000㎡超 → 幅員3m以上の通路（周囲は1.5m以上）。▶第2項：延べ3000㎡超は構造不問で同様の通路が必要（RC・S造等も対象）。▶第3項：公園・川等の防火上有効な空地に面する部分は通路省略可。▶第4項：通路両側が耐火構造等の場合は幅員1.5m以上に緩和可。<br><br>【令128条の3：地下街】地下の工作物内の店舗・事務所等（床面積合計1000㎡超）：地下道は幅員3m以上・天井高さ3m以上。各構えは耐火構造の壁・床・特定防火設備で区画（200㎡超は内部を200㎡以内ごとに防火区画）。内装は不燃材料とし、排煙設備・非常用照明・誘導灯等が必要。"
  },
  {
    "id": "law43",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "note": "【適用除外】耐火建築物・準耐火建築物（令113条），法21条の通火終了時間対応建築物等。木造建築物等の一般建築物で延べ1000㎡超の場合に特に確認が必要。防火壁の構造は令113条：自立する耐火構造・両端および上端が外壁・屋根から50cm以上突出させること等"
  },
  {
    "id": "law29",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "note": "【令128条の3の2】主要構造部が木造建築物等で延べ1000㎡超の建築物の居室等：壁・天井を準不燃材料以上で仕上げる。<br><br>【令128条の3の3】自動車車庫・自動車修理工場等：規模に関わらず内装制限の対象。<br><br>【令128条の4】特殊建築物（法別表第一(1)〜(4)項）の一定規模以上の用途部分・無窓居室が対象。<strong>火気使用室（コンロ等を設ける室）は用途・規模に関わらず対象となるため要注意。</strong><br><br>【令128条の5】内装材料：主要構造部の耐火性能と室の種類に応じて不燃・準不燃・難燃材料を使い分ける。壁の床から1.2m以下の腰壁部分は除外。"
  },
  {
    "id": "rei_wood",
    "law": "建築基準法施行令",
  ...
  },
  {
    ...
    "note": "同一敷地内に複数の木造建築物等がある場合は延べ面積の合計で判定。"
  },
  {
    "id": "law30",
    "law": "建築基準法",
