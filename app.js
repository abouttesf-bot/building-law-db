const articlesData = [
  ...
  },
  {
    ...
    "note": "【令127条：屋外への出口等】法35条が適用される建築物の避難階には、直通階段から道路・公園等に通じる屋外への出口を設け、その幅は直通階段の幅の合計以上とする。<br><br>【令128条：敷地内の通路幅員】建築物の出口から道路等に通じる敷地内の通路幅員は1.5m以上。ただし3階以下かつ延べ面積200㎡未満の建築物は90cm以上で可。<br><br>【令128条の2：大規模建築物の敷地内通路】▶第1項：主要構造部が木造等（不燃材料造以外）の建築物で延べ面積1000㎡超の場合、敷地内に通路（幅員3m以上。建築物の周囲に設ける場合は1.5m以上）を設ける。▶第2項：延べ面積3000㎡超の建築物は構造によらず（RC造・S造等の不燃材料造も含む）同様の通路が必要。木造に限らず大規模建築物全般が対象となる点に注意。<br><br>【令128条の3：地下街】地下の工作物内の店舗・事務所等（床面積合計1000㎡超）：地下道は幅員3m以上・天井高さ3m以上。各構えは耐火構造の壁・床・特定防火設備で区画（200㎡超は内部を200㎡以内ごとに防火区画）。内装は不燃材料とし、排煙設備・非常用照明・誘導灯等が必要。"
  },
  {
    "id": "law43",
    "law": "建築基準法",
