const articlesData = [
  ...
  },
  {
    ...
    "note": "【第1号】石綿その他の物質で政令で定めるものを含む建築材料の使用禁止 → すべての建築物に適用。<br><br>【第2号】石綿等をあらかじめ添付した建築材料（断熱材・保温材等）の使用禁止 → すべての建築物に適用。<br><br>【第3号】クロルピリホス・ホルムアルデヒドを発散する建材の使用制限および換気設備の設置義務（シックハウス対策） → 居室を有する建築物のみ対象。居室の換気回数0.5回/h以上の機械換気設備が必要（令20条の8）。"
  },
  {
    "id": "law35",
    "law": "建築基準法",
