const articlesData = [
  ...
  },
  {
    ...
    "category": "防火規定",
    "description": "木造等（木造・混構造等）で、地階を除く階数4以上・高さ16m超・別表第一(い)欄(5)(6)項用途で高さ13m超のいずれかに該当する建築物の主要構造部は、通常火災が終了するまで耐えられる防耐火性能が必要（第1項）",
    "note": "【対象構造】木造・混構造（可燃材料を主要構造部に用いるものが対象）。<br><br>【第1項第1号】地階を除く階数4以上。<br>【第1項第2号】高さ16m超。<br>【第1項第3号】別表第一(い)欄(5)項（倉庫）・(6)項（自動車車庫・自動車修理工場等）の特殊建築物で高さ13m超。<br><br>【第2項】延べ面積3000㎡超かつ可燃材料使用のものは別途適用（本DBでは第1項の条件で表示）。<br><br>令和4年法改正により規定が再編。法27条・法61条とは別に適用。令112条の面積区画（第4項・第5項）の根拠法令の一つ"
  },
  {
    "id": "law26",
    "law": "建築基準法",
