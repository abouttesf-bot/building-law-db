const articlesData = [
  {
    ...
    "note": "【第1号：高さ60m超】時刻歴応答解析による大臣認定が必要。<br><br>【第2号：高さ60m以下で一定規模以上】4階以上または高さ13m超等。許容応力度等計算（ルート2）または保有水平耐力計算（ルート3）が必要。<br><br>【第3号：第2号以外の中規模】木造3階以上または延べ300㎡超等。許容応力度計算（ルート1）が必要。<br><br>【第4号：小規模】木造2階以下かつ延べ300㎡以下等。構造計算によらず仕様規定（壁量計算等・令3章3節）で対応可。【2025年4月改正】旧4号区分廃止により木造の適用範囲が変更。"
  },
  {
    "id": "law28",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "category": "防火規定",
    "description": "地階を除く階数4以上・高さ16m超・別表第一(い)欄(5)・(6)項用途で高さ13m超・延べ面積3000㎡超のいずれかに該当する建築物の主要構造部は、通常火災が終了するまで耐えられる防耐火性能が必要",
    "note": "【第1項第1号】地階を除く階数4以上。<br>【第1項第2号】高さ16m超。<br>【第1項第3号】別表第一(い)欄(5)項（倉庫）・(6)項（自動車車庫・自動車修理工場等）の特殊建築物で高さ13m超。<br>【第2項】延べ面積3000㎡超（可燃材料使用のものに限る）。<br><br>令和4年法改正により規定が再編。法27条（特殊建築物）・法61条（防火地域）とは別に大規模建築物全般に適用。令112条の面積区画（第4項・第5項）の根拠法令の一つ"
  },
  {
    "id": "law26",
    "law": "建築基準法",
...
function matchesArticle(article, inp) {
  ...
  if (id === 'law21') {
    ...
    if (betten1_5_6.includes(inp.useType) && inp.height > 13) return true;
