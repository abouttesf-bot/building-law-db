const articlesData = [
  ...
  },
  {
    ...
    "note": "【令117条：適用範囲】特殊建築物（法別表第1(1)〜(4)項）・3階以上・延べ1000㎡超・無窓居室（令116条の2）のいずれか一つ該当で全条文が適用。無窓居室は規模不問で適用となるため要注意。 【令118条：客席からの出口幅】劇場等のみ：定員100人以下は1.5m以上、100人超は定員×1.5cm以上。 【令119条：廊下幅】両側居室の中廊下1.6m以上・その他1.2m以上（学校の生徒用は1.8m以上）。 【令120条：直通階段の歩行距離】耐火建築物50m以下・準耐火40m以下・その他30m以下（用途・構造により異なる）。 【令121条：2以上の直通階段】5階以上は用途不問で必要。劇場・共同住宅等は3・4階でも用途・面積により必要。 【令122条：避難階段の設置】5階以上または地下2階以下の居室に通じる直通階段は避難階段以上とする。 【令123条：構造】避難階段は耐火構造で区画し出入口は防火設備。特別避難階段（15階以上・地下3階以下）は付室を設け特定防火設備。 【令124条：物品販売店舗】延べ1500㎡超の物品販売店舗：各階通路幅の合計は3000㎡以下で240cm以上（3000㎡超は加算）。 【令125条：避難階の出口】出口幅は廊下幅の規定を準用し、直通階段の数以上の出口を確保。 【令126条：屋上広場】5階以上に物品販売系用途がある建築物は屋上に避難広場（当該用途床面積合計の1/4以上）を設ける。"
  },
  {
    "id": "rei126_2",
    "law": "建築基準法施行令",
