const articlesData = [
  ...
  },
  {
    ...
    "title": "便所",
    "category": "一般構造",
    "description": "便所には採光・換気のため直接外気に接する窓を設けなければならない（令28条）。ただし水洗便所で代替換気設備を設けた場合は不要。くみ取便所・浄化槽・合併処理浄化槽の構造基準、漏水検査、井戸との距離等を規定",
    "memo": "【令28条】便所には直接外気に接する窓（採光・換気）が必要。水洗便所で代替換気設備を設けた場合は不要。<br>【令29条】くみ取便所の構造基準（漏水・臭気・雨水流入防止）。<br>【令30条】都市計画区域・準都市計画区域内の学校・病院・劇場等の便所は追加基準（汚水管の漏水防止・換気開口からのはえ侵入防止等）が必要。<br>【令31〜33条】改良便槽の構造基準・漏水検査。<br>【令34条】くみ取便所の便槽は井戸から5m以上（条件により1.8m以上）。<br>【令35条】合併処理浄化槽の構造基準。"
  },
  {
    "id": "law35",
    "law": "建築基準法",
