const articlesData = [
  ...
  },
  {
    ...
    "note": "【住宅用】幅75cm以上・蹴上23cm以下・踏面15cm以上。【共同住宅の共用・特殊建築物等・3階以上・1000㎡超】幅120cm以上・蹴上22cm以下・踏面21cm以上。【小中学校（生徒用）】幅140cm以上。屋外階段は所定の緩和あり（共用等：90cm、住宅等：60cm）。すべての建築物に適用"
  },
  {
    "id": "rei24",
    "law": "建築基準法施行令",
    ...
    "note": "設置間隔：高さ3m以内ごと（令23条の表第1〜2号：特殊建築物等）、4m以内ごと（第3〜4号：住宅等）。踊り場の踏幅は階段の幅以上。すべての建築物の階段に適用"
  },
  {
    "id": "rei25",
    "law": "建築基準法施行令",
    ...
    "note": "手すり設置はすべての階段に適用（高さ1m以下の部分は除外）。階段の幅が3mを超える場合は中間に手すり等が必要。令26条（傾斜路）にも準用される"
  },
  {
    "id": "rei117",
    "law": "建築基準法施行令",
    ...
    "title": "避難規定の適用範囲",
    "category": "避難規定",
    "description": "令5章2節（令118条〜令126条の4）の避難規定が適用される建築物の範囲：①法別表第1（い）欄(1)〜(4)項の特殊建築物、②3階以上、③延べ面積1000㎡超、④令116条の2の無窓居室を有するもの",
    "note": "令117条は避難規定の適用トリガー。①〜④のいずれかに該当すると令119条（廊下幅）・令120条（直通階段）・令121条（2以上の直通階段）・令122条（避難階段）・令125条（出口幅）等が一括適用される。令116条の2の無窓居室は規模不問で適用となるため要注意"
  },
  {
    "id": "rei118",
    "law": "建築基準法施行令",
    ...
    "title": "客席からの出口の幅",
    "category": "避難規定",
    "description": "劇場・映画館・演芸場・観覧場・公会堂・集会場の客席から屋外への出口の幅の合計は、定員100人以下は1.5m以上、100人超は定員×1.5cm以上としなければならない",
    "note": "対象：劇場・映画館・演芸場・観覧場・公会堂・集会場のみ。令117条の適用建築物に該当すれば令119条以降も別途適用される"
  },
  {
    "id": "rei124",
    "law": "建築基準法施行令",
    ...
    "title": "物品販売店舗の避難規定",
    "category": "避難規定",
    "description": "床面積の合計が1500㎡を超える物品販売業を営む店舗の各階の売場・屋上広場への通路・階段の幅は、各階の床面積合計に応じた幅以上としなければならない",
    "note": "通路幅の合計：床面積3000㎡以下は240cm以上、3000㎡超は240cm＋（床面積−3000）÷10 cm以上。令121条第1項第5号（物品販売店舗の2直）も合わせて確認。延べ面積1500㎡超が適用の閾値"
  },
  {
    "id": "rei126",
    "law": "建築基準法施行令",
    ...
    "title": "屋上広場等",
    "category": "避難規定",
    "description": "5階以上の階を百貨店・マーケット・物品販売店舗等の用途に供する建築物の屋上には、避難のための広場を設けなければならない",
    "note": "対象：5階以上に物品販売系（百貨店・マーケット・展示場・物品販売業を営む店舗）の用途がある建築物。屋上広場の面積は当該用途の床面積合計の1/4以上。令121条（2以上の直通階段）と合わせて確認すること"
  },
  {
    "id": "law64",
    "law": "建築基準法",
...
function matchesArticle(article, inp) {
  ...
  if (id === 'rei23') return true;
  if (id === 'rei24') return true;
  if (id === 'rei25') return true;

  if (id === 'rei117') return matchesLaw117(inp);
  ...
  if (id === 'rei124') {
    return inp.useType === '物品販売業を営む店舗' && inp.totalFloorArea > 1500;
  }

  if (id === 'rei126') {
    const targets = ['百貨店', 'マーケット', '展示場', '物品販売業を営む店舗'];
    return targets.includes(inp.useType) && inp.stories >= 5;
  }
