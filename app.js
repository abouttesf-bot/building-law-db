const articlesData = [
  ...
  },
  {
    ...
    "note": "両側居室の中廊下は1.6m以上、その他は1.2m以上（用途により異なる）"
  },
  {
    "id": "rei120",
    "law": "建築基準法施行令",
    ...
    "note": "歩行距離の上限：耐火建築物の居室50m以下、準耐火40m以下、その他30m以下（用途・構造により異なる）。居室がある全建築物で確認が必要"
  },
  {
    "id": "rei121",
    "law": "建築基準法施行令",
    ...
    "note": "用途・階数・面積の組み合わせで判定。5階以上は用途にかかわらず適用（令121条第1項第7号）。用途によっては3・4階でも2直が必要なケースあり"
  },
  {
    "id": "rei126_2",
    "law": "建築基準法施行令",
  ...
  },
  {
    ...
    "category": "構造規定",
    "description": "前三号に該当しない建築物（平屋かつ延べ200㎡以下が主な対象）は、構造計算によらず仕様規定（壁量計算等）で構造耐力上の安全性を確保することができる",
    "note": "【2025年4月改正後】旧・4号建築物区分は廃止。法6条1項3号建築物（平屋かつ延べ200㎡以下）が主な対象。法6条1項2号建築物（2階以上または延べ200㎡超）は第3号（ルート1）以上が必要となり、仕様規定のみでは原則不可。令3章3節の仕様規定（令46条壁量計算等）を満たす必要あり"
  },
  {
    "id": "rei126_3",
    "law": "建築基準法施行令",
  ...
  },
  {
    ...
    "note": "5階以上の階が対象。15階以上または地下3階以下は特別避難階段（令123条第3項）が必要。避難階段の構造は令123条による"
  },
  {
    "id": "law23",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "note": "【避難階段（第1・2項）】耐火構造の壁・床で囲み、屋内は採光窓・換気口を設け出入口は防火設備。【特別避難階段（第3項）】15階以上・地下3階以下に必要。付室（バルコニーまたは排煙設備を有する室）を設け、付室の出入口は特定防火設備とする"
  },
  {
    "id": "law20_1_3",
    "law": "建築基準法",
    ...
    "category": "構造規定",
    "description": "高さ60m以下で第2号以外の法6条1項1号・2号建築物：令82条の許容応力度計算（ルート1）により構造の安全性を確認しなければならない",
    "note": "【2025年4月改正後】法6条1項2号建築物（2階以上または延べ200㎡超）のうち第2号（ルート2・3）に該当しないものが主な対象。2階建て・延べ200㎡超の木造住宅等もルート1以上が必要。令81条第3項の大臣認定プログラムの使用も可"
  },
  {
    "id": "law31",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "title": "木造建築物の壁量計算",
    "category": "構造規定",
    "description": "木造建築物の各階・各方向の耐力壁（筋かい・構造用面材等）は、床面積・見付面積から算定した必要壁量以上としなければならない",
    "note": "木造建築物の場合に適用。令46条第4項の表により必要壁量（cm/㎡）を算定。存在壁量が必要壁量以上であることを確認。筋かいの種類・角度により有効倍率が異なる。【2025年4月改正後】旧・4号特例は廃止。法6条1項2号建築物（2階以上または延べ200㎡超の木造）も壁量計算書の審査対象となった"
  },
  {
    "id": "rei77",
    "law": "建築基準法施行令",
  ...
  },
  {
    ...
    "note": "出口の有効幅は令119条（廊下の幅）の規定を準用。出口の数は令121条の直通階段の数以上を確保すること。劇場等は客席定員に応じた出口幅が別途必要（令118条）。避難距離（令120条）も合わせて確認"
  },
  {
    "id": "rei128_4",
    "law": "建築基準法施行令",
  ...
  },
  {
    ...
    "title": "木造の構造基準",
    "category": "構造規定",
    "description": "木造建築物の各部材（柱・梁・筋かい・仕口・継手等）の品質・構造・接合に関する技術的基準",
    "note": "主要規定：令40条（木材の品質・含水率）・令41条（柱の小径：建物高さの1/33等）・令44条（筋かいの設置・斜め45°以内等）・令47条（仕口・継手：ドリフトピン・ボルト等）・令49条（外壁・床下の防腐措置）。【2025年4月改正後】旧・4号特例廃止により、2階以上または延べ200㎡超の木造建築物（法6条1項2号）も仕様規定の審査対象となった"
  },
  {
    "id": "rei_masonry",
    "law": "建築基準法施行令",
...
function matchesArticle(article, inp) {
  ...
  if (id === 'rei119') {
    const targets = ['学校', '病院', '診療所', '共同住宅', '寄宿舎', '下宿', '児童福祉施設', 'ホテル', '旅館'];
    return targets.includes(inp.useType);
  }
  ...
  if (id === 'rei121') {
    ...
    if (targets.includes(inp.useType) && inp.stories >= 3) return true;
    if (inp.stories >= 5) return true;
    return false;
  }
  ...
  if (id === 'law20_1_4') {
    ...
    // 2025年改正後：平屋かつ延べ200㎡以下（法6条1項3号建築物）が主な対象
    return inp.stories <= 1 && inp.totalFloorArea <= 200;
  }
  ...
  if (id === 'law20_1_3') {
    if (inp.height > 60) return false;
    if (inp.stories >= 4 || inp.height > 13) return false; // 第2号の対象
    // 2025年改正後：2階以上または延べ200㎡超（法6条1項2号）が第3号の主な対象
    if (inp.stories <= 1 && inp.totalFloorArea <= 200) return false; // 第4号（仕様規定）の対象
    return true;
  }
  ...
  if (id === 'rei125') {
    const targets125 = ['劇場', '映画館', '演芸場', '観覧場', '公会堂', '集会場',
      '病院', '診療所', 'ホテル', '旅館', '共同住宅', '寄宿舎', '下宿',
      '学校', '体育館', '百貨店', 'マーケット', '展示場',
      'キャバレー', 'カフェ', 'ナイトクラブ', 'バー', 'ダンスホール',
      '遊技場', '公衆浴場', '待合', '料理店', '飲食店', '物品販売業を営む店舗'];
    return targets125.includes(inp.useType) || inp.stories >= 3 || inp.totalFloorArea > 1000;
  }
