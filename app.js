const articlesData = [
  {
    ...
    "memo": "【第1号：高さ60m超】時刻歴応答解析による大臣認定が必要。<br>【第2号：高さ60m以下で一定規模以上】4階以上または高さ13m超等。許容応力度等計算（ルート2）または保有水平耐力計算（ルート3）が必要。<br>【第3号：第2号以外の中規模】木造3階以上または延べ300㎡超等。許容応力度計算（ルート1）が必要。<br>【第4号：小規模】木造2階以下かつ延べ300㎡以下等。構造計算によらず仕様規定（壁量計算等・令3章3節）で対応可。"
  },
  {
    "id": "law28",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "memo": "【第1号】建築材料への石綿等の使用禁止 → すべての建築物に適用。<br><br>【第2号】石綿等が添付されている建築材料の使用禁止 → すべての建築物に適用。<br><br>【第3号】クロルピリホス・ホルムアルデヒドを発散する建材の使用制限および換気設備の設置義務（シックハウス対策） → 居室を有する建築物のみ対象。居室の換気回数0.5回/h以上の機械換気設備が必要（令20条の8）。"
  },
  {
    "id": "rei_ventilation",
    "law": "建築基準法施行令",
    ...
    "memo": "【換気設備の技術基準（令20条の2）】法28条第2項の換気設備・法28条の2第3号（シックハウス対策）の機械換気設備の構造基準。有効換気量の計算（0.5回/h以上）、ダクトの材料・構造・給排気口の位置等。<br><br>【火気使用室の換気（令20条の3）】コンロ・ガス器具等の火気使用設備を設けた室は、発熱量に応じた有効換気量を確保する換気設備が必要。調理室・ボイラー室等に適用。密閉式燃焼器具のみの場合は不要。<br><br>【機械換気設備の構造（令129条の2の6）】給気機・排気機・ダクト等の構造基準。シックハウス対策換気設備はこの基準による。令20条の2の有効換気量計算と組み合わせて確認が必要。<br><br>【中央管理方式の空調換気設備（令129条の2の7）】特定規模・用途の建築物に設ける中央管理方式換気設備の技術基準。浮遊粉じん・CO・CO₂・温度・湿度・気流の管理基準値が規定されている。"
  },
  {
    "id": "law35",
    "law": "建築基準法",
    ...
    "memo": "【適用対象（いずれか一つで適用）】①法別表第一(1)〜(4)項の特殊建築物（規模不問）、②3階以上の建築物、③延べ面積1000㎡超の建築物、④採光無窓居室（令116条の2第1項第1号）または排煙無窓居室（同第2号）を有する建築物。<br><br>【連動する施行令の規定】令117〜126条（廊下幅・直通階段・避難階段・出入口等）／令126条の2・3（排煙設備）／令126条の4・5（非常用照明装置）／令126条の6・7（非常用進入口）"
  },
  {
    "id": "law35_2",
    "law": "建築基準法",
    ...
    "memo": "施行令第128条の3の2以降の内装制限が適用。<strong>火気使用室（コンロ等を設ける調理室等）がある場合は用途・規模を問わず対象となる（令128条の4第4項）ため、すべての建築物で要確認。</strong>"
  },
  {
    "id": "law48",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "memo": "【第1項】別表第一(1)〜(4)項の特殊建築物で3階以上に用途部分の居室がある場合。<br><br>【第2項】(2)項用途（病院・ホテル・共同住宅等）で用途部分300㎡以上、(4)項用途（物販・飲食等）で1000㎡以上。<br><br>【第3項】別表第一(に)欄の規模以上のもの（倉庫200㎡以上、自動車車庫150㎡以上等）。"
  },
  {
    "id": "rei112_area",
    "law": "建築基準法施行令",
    ...
    "memo": "【1500㎡区画（第1項）】法的根拠を問わない一般の耐火・準耐火建築物（任意耐火・防火地域の法61条等）。1時間準耐火構造の床壁＋特定防火設備で区画。<br><br>【1000㎡区画（第5項）】①法21条（通常火災終了時間1時間以上）②法27条・法61条（準防火地域）による準耐火建築物のうちイ-1・ロ-2系（1時間準耐火）に該当するもの。<br><br>【500㎡区画（第4項）】①法21条（通常火災終了時間1時間未満）②法27条・法61条（準防火地域）による準耐火建築物のうちイ-2・ロ-1系（45分準耐火）に該当するもの。<br><br>【注意】3つの区画面積のうち適用されるのは建物の法的根拠に対応する1種類のみ。竪穴区画（第7項）・異種用途区画（第18項）も合わせて確認すること。"
  },
  {
    "id": "rei112_7",
    "law": "建築基準法施行令",
  ...
  },
  {
    ...
    "memo": "【根拠】法27条（耐火・準耐火建築物としなければならない特殊建築物）の各項のいずれかに該当する部分が対象。<br><br>【対象となる用途】法別表第一(い)欄(1)〜(6)項すべてが対象となり得る。(1)劇場・観覧場・集会場等、(2)病院・ホテル・共同住宅等、(3)学校・体育館・図書館等、(4)百貨店・飲食店・物品販売店舗等、(5)倉庫、(6)自動車車庫・自動車修理工場等。加えて政令で定める数量以上の危険物貯蔵場・処理場も対象。<br><br>【区画方法】床・壁：1時間準耐火構造。開口部：特定防火設備（随時閉鎖型）。<br><br>【注意】自動車車庫と他用途の区画は令112条第19項も適用。複合用途では両項の確認が必要。"
  },
  {
    "id": "rei117_126",
    "law": "建築基準法施行令",
  ...
  },
  {
    ...
    "memo": "【令126条の2：設置義務】排煙無窓居室（令116条の2第1項第2号）は規模に関わらず適用。床面積100㎡以内で準不燃材料仕上げ等の免除規定（同条第1項各号）に該当する場合は不要。<br><br>【令126条の3：構造】自然排煙：排煙口は天井から80cm以内・有効開口面積は床面積の1/50以上。機械排煙：防煙区画ごとに1㎡当たり毎分1㎥以上の排煙量が必要。"
  },
  {
    "id": "rei126_4",
    "law": "建築基準法施行令",
    ...
    "memo": "【令126条の4：設置義務】法35条が適用される建築物（特殊建築物・3階以上・無窓居室・延べ1000㎡超）の居室・廊下・階段・その他避難上必要な部分に設置。ただし避難階の直接屋外に通じる出口のある室・その他大臣認定を受けた場合は除く。<br><br>【令126条の5：構造】直接照明とし、床面において1lx（蛍光灯等は2lx）以上の照度を確保。予備電源（蓄電池等）により停電後30分以上点灯できること。照明器具は難燃材料で造り、または覆うこと。"
  },
  {
    "id": "rei126_6",
    "law": "建築基準法施行令",
    ...
    "memo": "【令126条の6：設置義務】3階以上の建築物の外壁面（道または通路に面する部分）に設置。ただし、①非常用エレベーターを設けた場合、②窓等（幅75cm以上・高さ1.2m以上、かつ格子等の障害物なし）を10m以内ごとに設けた場合は不要。<br><br>【令126条の7：構造】バルコニー付きの開口部とし、間隔40m以下ごとに設置。開口部は幅75cm以上・高さ1.2m以上（床面からの高さ80cm以下）。バルコニーは奥行1m以上・長さ4m以上。外部から開放または破壊できる構造とし、赤色灯および赤色の三角マーク（一辺20cm以上）を表示する。"
  },
  {
    "id": "rei129_13_3",
    "law": "建築基準法施行令",
  ...
  },
  {
    ...
    "memo": "【配管の共通基準（令129条の2）】配管材料・勾配・ウォーターハンマー防止措置・断熱・防露等。<br><br>【給水タンク・圧力タンク・給湯設備（令129条の2の2〜令129条の2の3）】有効容量・転倒防止・保守点検スペース・通気管・マンホール等の設置基準。屋上・地下の受水槽・高置水槽が対象。<br><br>【排水配管・通気管・阻集器（令129条の2の4〜令129条の2の5）】排水トラップ（脱臭・害虫防止）・通気管の設置基準。グリーストラップ（油脂阻集器）等の阻集器の設置基準。飲食店・調理施設等では油脂分の阻集が必要。"
  },
  {
    "id": "law61",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "memo": "【令127条：屋外への出口等】法35条が適用される建築物の避難階には、直通階段から道路・公園等に通じる屋外への出口を設け、その幅は直通階段の幅の合計以上とする。<br><br>【令128条：敷地内の通路幅員】建築物の出口から道路等に通じる敷地内の通路幅員は1.5m以上。ただし3階以下かつ延べ面積200㎡未満の建築物は90cm以上で可。<br><br>【令128条の2：大規模建築物の敷地内通路】▶第1項：木造建築物等で延べ1000㎡超 → 幅員3m以上の通路（周囲は1.5m以上）。▶第2項：延べ3000㎡超は構造不問で同様の通路が必要（RC・S造等も対象）。▶第3項：公園・川等の防火上有効な空地に面する部分は通路省略可。▶第4項：通路両側が耐火構造等の場合は幅員1.5m以上に緩和可。<br><br>【令128条の3：地下街】地下の工作物内の店舗・事務所等（床面積合計1000㎡超）：地下道は幅員3m以上・天井高さ3m以上。各構えは耐火構造の壁・床・特定防火設備で区画（200㎡超は内部を200㎡以内ごとに防火区画）。内装は不燃材料とし、排煙設備・非常用照明・誘導灯等が必要。"
  },
  {
    "id": "law43",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "memo": "【第1項】共同住宅・長屋・寄宿舎・下宿：各戸の界壁を準耐火構造以上で小屋裏・天井裏まで到達させる。【第2項】学校・病院・ホテル・児童福祉施設等：防火上主要な間仕切壁を準耐火構造以上とし天井裏まで到達させる"
  },
  {
    "id": "law23",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "memo": "【適用除外】耐火建築物・準耐火建築物（令113条），法21条の通火終了時間対応建築物等。木造建築物等の一般建築物で延べ1000㎡超の場合に特に確認が必要。防火壁の構造は令113条：自立する耐火構造・両端および上端が外壁・屋根から50cm以上突出させること等"
  },
  {
    "id": "law29",
    "law": "建築基準法",
    ...
    "memo": "地階に居室がある場合に適用。令20条の2（機械換気設備の設置義務）・令22条の2（防湿の措置）等の技術的基準あり。採光の確保が困難なケースが多く、換気設備（0.5回/h以上）の設置が必要になる場合が多い"
  },
  {
    "id": "law54",
    "law": "建築基準法",
    ...
    "memo": "全低層住居専用地域で自動適用ではなく、特定行政庁が都市計画で指定した場合のみ適用。適用除外：①外壁後退距離以内に外壁・柱が来ない部分の延長が3m以下、②物置等の床面積5㎡以内（令135条の20）"
  },
  {
    "id": "law55",
    "law": "建築基準法",
    ...
    "memo": "10m・12mのどちらが適用されるかは特定行政庁が都市計画で指定。法56条（道路斜線・北側斜線等）も別途適用される。高さの算定は令2条第1項六号（平均地盤面からの高さ）による"
  },
  {
    "id": "law56_2",
    "law": "建築基準法",
    ...
    "memo": "対象地域：住居系全地域・近隣商業・準工業地域（工業・工業専用地域は除外）。対象の高さ：軒高7m超または地階を除く階数3以上（別表第四）。日影の計測面：平均地盤面から1.5m（低層）または4m（中高層等）の水平面。規制内容は自治体の条例等で異なる場合あり"
  },
  {
    "id": "rei116_2",
    "law": "建築基準法施行令",
    ...
    "memo": "【採光無窓居室（第1項第1号）】採光有効面積が床面積の1/20未満の居室 → 法35条が規模不問で適用（非常照明・廊下幅等）。【排煙無窓居室（第1項第2号）】排煙上有効な開口面積が床面積の1/50未満かつ1㎡未満の居室 → 令126条の2の排煙設備が規模不問で必要。天窓・ハイサイドライトの有効面積算定に注意"
  },
  {
    "id": "law31",
    "law": "建築基準法",
    ...
    "memo": "下水道処理区域内は水洗便所が義務（令35条）。くみ取り式は臭気・害虫等に配慮した構造（令29条〜令34条）。建設地が下水道処理区域内かどうかは自治体に確認が必要"
  },
  {
    "id": "law33",
    "law": "建築基準法",
    ...
    "memo": "令129条の14（設置基準）・令129条の15（構造）による。平均地盤面から高さ20mを超える部分を雷撃から保護。政令で定める建築物（危険物貯蔵場等）は一部適用外。受雷部・引下げ導線・接地極の構成が必要"
  },
  {
    "id": "law34",
    "law": "建築基準法",
    ...
    "memo": "一般EV：令129条の3〜令129条の12の安全装置・かご・昇降路等の基準に適合が必要。EV設置は建築基準法上の義務ではないが、バリアフリー法・条例等で求められる場合あり。非常用EV（高さ31m超）は法34条第2項・令129条の13の3による"
  },
  {
    "id": "law34_2",
    "law": "建築基準法",
    ...
    "memo": "法36条により、建築設備の構造・強度・防火・衛生に関する技術的基準は施行令に委任されている。主な関連施行令：給水・排水の配管設備（令129条の2〜令129条の2の5）、機械換気設備（令129条の2の6）、中央管理方式の空調換気設備（令129条の2の7）。電気設備については法32条・電気事業法・消防法も参照。"
  },
  {
    "id": "rei129_esc",
    "law": "建築基準法施行令",
    ...
    "memo": "【エスカレーター（令129条の12）】踏段の幅（1.1m以下）・勾配（30°以下）・速度・制動装置・転落防止措置等の構造基準。<br><br>【小荷物専用昇降機（令129条の13）】かごの最大積載量・人が乗り込めない大きさの上限・出し入れ口の戸の構造等の基準。ダムウェーターとも呼ばれる。エレベーター（法34条・令129条の3〜令129条の13の2）とは別途規定。"
  },
  {
    "id": "rei77",
    "law": "建築基準法施行令",
    ...
    "memo": "令93条の地盤調査により長期許容応力度を確認後、基礎形式を選定（直接基礎・杭基礎等）。地耐力の目安：長期許容応力度20kN/㎡未満は原則杭基礎等。令38条（基礎の構造種類）も参照。地盤沈下・液状化リスクは別途検討が必要"
  },
  {
    "id": "rei128_4",
    "law": "建築基準法施行令",
    ...
    "memo": "【令128条の3の2】主要構造部が木造建築物等で延べ1000㎡超の建築物の居室等：壁・天井を準不燃材料以上で仕上げる。<br><br>【令128条の3の3】自動車車庫・自動車修理工場等：規模に関わらず内装制限の対象。<br><br>【令128条の4】特殊建築物（法別表第一(1)〜(4)項）の一定規模以上の用途部分・無窓居室が対象。<strong>火気使用室（コンロ等を設ける室）は用途・規模に関わらず対象となるため要注意。</strong><br><br>【令128条の5】内装材料：主要構造部の耐火性能と室の種類に応じて不燃・準不燃・難燃材料を使い分ける。壁の床から1.2m以下の腰壁部分は除外。"
  },
  {
    "id": "rei_wood",
    "law": "建築基準法施行令",
    ...
    "memo": "主要規定：令40条（木材の品質・含水率）・令41条（柱の小径：建物高さの1/33等）・令44条（筋かいの設置）・令47条（仕口・継手：ドリフトピン・ボルト等）・令49条（外壁・床下の防腐措置）。【令46条壁量計算】令46条第4項の表により必要壁量（cm/㎡）を算定。存在壁量が必要壁量以上であることを確認。筋かいの種類・角度により有効倍率が異なる。【2025年4月改正後】旧・4号特例廃止により、3階以上または延べ300㎡超の木造建築物も仕様規定の審査対象となった"
  },
  {
    "id": "rei_masonry",
    "law": "建築基準法施行令",
    ...
    "memo": "令52条（組積材の品質）・令55条（壁の長さと開口幅：壁長さは開口幅の3倍以上等）・令56条（壁の厚さ：最小20cm以上）・令57条（臥梁の設置）・令60条（間仕切壁）。組積造は耐震性が低いため現在はほとんど新築に用いられず、既存建築物の増改築が主な適用場面"
  },
  {
    "id": "rei_block",
    "law": "建築基準法施行令",
    ...
    "memo": "令62条の3（耐力壁の厚さ・配筋：縦横共に径9mm以上等）・令62条の4（耐力壁の配置：直交壁を設ける等）・令62条の5（壁量：15cm/㎡以上）・令62条の6（臥梁：各階の耐力壁の上部に設置）。高さ制限：高さ11m以下・軒高9m以下（令62条の3第6項）"
  },
  {
    "id": "rei_steel",
    "law": "建築基準法施行令",
    ...
    "memo": "令63条（鋼材の品質：JIS規格等）・令64条（圧縮材の有効細長比：200以下）・令65条（柱脚部：アンカーボルト・ベースプレート等）・令66条（接合部の強度確保）・令67条（高力ボルト・溶接の施工基準）・令68条（通し柱の設置）。耐火・防耐火被覆（耐火建築物等の場合）も合わせて確認"
  },
  {
    "id": "rei_rc",
    "law": "建築基準法施行令",
    ...
    "memo": "令71条（コンクリートの強度：設計基準強度の確認）・令73条（鉄筋の継手・定着長さ）・令77条（柱の帯筋：径6mm以上・間隔150mm以下等）・令78条の2（梁のあばら筋）・令79条（かぶり厚さ：屋外部分2cm以上・基礎6cm以上等）。中性化・塩害対策も設計上の重要事項"
  },
  {
    "id": "rei_src",
    "law": "建築基準法施行令",
    ...
    "memo": "令79条の4によりRC造の規定（令71条〜令79条の3）と鉄骨造の規定（令64条〜令68条）を準用。鉄骨とコンクリートの一体性確保・かぶり厚さ・鉄骨のサイズとRC断面の整合性に注意。超高層建築物で多用される複合構造"
  },
  {
    "id": "law40",
    "law": "建築基準法",
    ...
    "memo": "法39条（災害危険区域）・法40条は全国一律の基準に上乗せして地方独自の制限を設ける根拠規定。例：豪雪地域の積雪荷重の割増・沖縄の防風規定・東京都の単体規定条例等。適用される自治体の条例を個別に確認する必要がある。法6条1項の確認申請では条例制限も審査対象となる"
  },
  {
    "id": "law68_2",
    "law": "建築基準法",
    ...
    "memo": "地区計画・特定街区・景観地区・風致地区等が定められた区域において市区町村が条例化している場合に適用される。条例化されていない場合は制限なし。対象かどうかは都市計画図・市区町村窓口で地区計画等の有無を確認して判断すること。条例化されている場合は用途・容積率・建蔽率・高さ・壁面位置・外壁後退距離等の独自制限が課される。法68条の3〜9（地区計画等の区域内の特例）も合わせて参照"
  },
  {
    "id": "law19",
    "law": "建築基準法",
    ...
    "memo": "第1項：敷地は接道より高く（やむを得ない場合は排水・防水措置）。第2項：湿潤地・出水危険地は盛土等が必要。第4項：がけ崩れ・地すべりのおそれのある土地は擁壁設置等の措置。令80条の3（がけに近接する建築物の制限）も参照"
  },
  {
    "id": "law25",
    "law": "建築基準法",
  ...
  },
  {
    ...
    "memo": "遮音性能の基準：令22条の3・告示1827号による透過損失（125Hzで25dB以上・500Hzで45dB以上）。令114条第1項（準耐火構造・小屋裏到達）も同時に適用される。リノベーション時も既存界壁の確認が必要"
  },
  {
    "id": "law32",
    "law": "建築基準法",
    ...
    "memo": "令129条の14（電気設備の構造基準）等による。避雷設備（法33条）・非常用照明（令126条の4）・非常用エレベーターの電源設備等も関連。電気設備の設計・施工は電気工事士法の有資格者が行うこと"
  },
  {
    "id": "law37",
    "law": "建築基準法",
    ...
    "memo": "対象材料（別表第三）：木材・鋼材・コンクリート・骨材・混和材料・高力ボルト・アンカーボルト等。JIS・JAS品以外を使用する場合は大臣認定が必要。施工時の品質管理・材料証明書の保管が重要"
  },
  {
    "id": "law62",
    "law": "建築基準法",
    ...
    "memo": "防火・準防火地域内の全建築物が対象。不燃材料（瓦・スレート・金属板等）またはこれに準ずる性能のものを使用する必要がある。法22条の指定区域と重複する場合は本条（法62条）が優先適用される"
  },
  {
    "id": "rei23",
    "law": "建築基準法施行令",
    ...
    "memo": "【住宅用】幅75cm以上・蹴上23cm以下・踏面15cm以上。【共同住宅の共用・特殊建築物等・3階以上・1000㎡超】幅120cm以上・蹴上22cm以下・踏面21cm以上。【小中学校（生徒用）】幅140cm以上。屋外階段は所定の緩和あり（共用等：90cm、住宅等：60cm）。2階以上の建築物に適用"
  },
  {
    "id": "rei24",
    "law": "建築基準法施行令",
    ...
    "memo": "設置間隔：高さ3m以内ごと（令23条の表第1〜2号：特殊建築物等）、4m以内ごと（第3〜4号：住宅等）。踊り場の踏幅は階段の幅以上。2階以上の建築物の階段に適用"
  },
  {
    "id": "rei25",
    "law": "建築基準法施行令",
    ...
    "memo": "手すり設置は2階以上の建築物の階段に適用（高さ1m以下の部分は除外）。階段の幅が3mを超える場合は中間に手すり等が必要。令26条（傾斜路）にも準用される"
  },
  {
    "id": "law64",
    "law": "建築基準法",
    ...
    "memo": "対象：防火地域のみ（準防火地域は本条の対象外）。屋上設置の看板または高さ3m超の看板・広告塔が条件。高さ4mを超える広告塔は法88条により確認申請が必要（令138条第1項第3号）。主要部分（骨組・枠組等）を不燃材料（鉄・アルミ等）で造ることが必要"
  }
];
