const articlesData = [
  ...
  },
  {
    ...
    "title": "建築物に設ける煙突",
    "category": "一般構造",
    "description": "建築物に設ける煙突は、政令で定める技術的基準（令115条：煙突の高さ・構造・材料等）に適合しなければならない",
    "note": "令115条：煙突先端は屋根面から60cm以上突出・内径・燃焼設備の種類に応じた高さ・断熱等の構造基準。薪ストーブ・ペレットストーブ設置時に特に確認が必要。防火・準防火地域内では不燃材料使用（法62条）も合わせて確認すること"
  }
];
