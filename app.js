const articlesData = [
  ...
  },
  {
    ...
    "title": "異種用途区画",
    "category": "防火規定",
    "description": "法別表第一(い)欄(1)〜(4)項の特殊建築物用途部分と他の用途部分が同一建築物内にある場合、その境界を1時間準耐火基準の床・壁および特定防火設備で区画しなければならない",
    "note": "【適用対象となる特殊用途（法別表第一(い)欄(1)〜(4)項）】(1)劇場・映画館・演芸場・観覧場・公会堂・集会場、(2)病院・診療所・ホテル・旅館・下宿・共同住宅・寄宿舎・児童福祉施設等、(3)学校・体育館・博物館・美術館・図書館・ボーリング場・スキー場・スケート場・水泳場・スポーツ練習場、(4)百貨店・マーケット・展示場・キャバレー・カフェ・ナイトクラブ・バー・遊技場・公衆浴場・待合・料理店・飲食店・物品販売業を営む店舗。<br><br>【区画方法】床・壁：1時間準耐火基準に適合する準耐火構造。開口部：特定防火設備（煙感知器と連動する随時閉鎖型）。<br><br>【注意】自動車車庫の部分と他の用途部分の区画は令112条第19項が適用される。複合用途建築物では両項の適用を要確認。"
  },
  {
    "id": "rei117_126",
    "law": "建築基準法施行令",
